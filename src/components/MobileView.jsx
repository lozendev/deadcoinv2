...
export default function MobileView() {
  ...
  return (
    ...
    >
      ...
      {/* Center Container: X and Telegram Social Buttons */}
      <div className="absolute inset-0 flex items-center justify-center gap-6 pointer-events-none">
        ...
        <a
          ...
          className="pointer-events-auto w-16 h-16 bg-white rounded-full shadow-[0_0_30px_rgba(255,255,255,0.7)] flex items-center justify-center transition-transform active:scale-95 border border-white/40"
        >
